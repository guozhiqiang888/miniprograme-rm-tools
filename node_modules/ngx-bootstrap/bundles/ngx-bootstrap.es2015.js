...
class BsDatepickerInputDirective {
    constructor(_picker, _config, _localeService, _renderer, _elRef, changeDetection) {
...
class BsDaterangepickerInputDirective {
    ...
    writeValue(value) {
        if (!value) {
            ...
            this._value = _input
                .map((_val) => parseDate(_val, this._config.dateInputFormat, this._localeService.currentLocale))
...
function translate$2(num, withoutSuffix, key) {
    let result = num + ' ';
    switch (key) {
        case 'ss':
